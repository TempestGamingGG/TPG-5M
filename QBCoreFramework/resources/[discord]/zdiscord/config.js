...
// PUBLIC VALUES
const FiveMServerName = "Tempest Gaming FiveM";
const DiscordInviteLink = "https://discord.gg/eyTwTwdatY";
const FiveMServerIP = "216.219.80.170";
...
// DISCORD BOT
const DiscordBotToken = "MTA2NzM3NDkwNzQxNzE3ODE5NA.GgY8wc.eZJYq2DsVFUxPB77b2gMJQ9dEQ_KLOuqfZgcis";
const DiscordGuildId = "869775145953288194";

// STAFF CHAT
const EnableStaffChatForwarding = True;
const DiscordStaffChannelId = "1067376736834158592";
...
const DiscordWhitelistRoleIds = "869776929568477234, 869776775994044456, 958050464535052338, 1067557589023469619";

// SLASH COMMANDS / DISCORD PERMISSIONS
const EnableDiscordSlashCommands = true;
const DiscordModRoleId = "869776367812767816";
const DiscordAdminRoleId = "869776593571184700, 1067557589023469619";
const DiscordGodRoleId = "869776775994044456, 869776929568477234";
